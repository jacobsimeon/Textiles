...
public class Textile {
  ...
  public func attributes(
    ...
    var font = UIFont(descriptor: descriptor, size: fontSize ?? UIFont.systemFontSize)

    if let scalingStyle = self.scalingStyle {
      font = scalingStyle.metrics.scaledFont(for: font, compatibleWith: traitCollection)
    }
